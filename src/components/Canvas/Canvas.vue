  ...
  <div class="bg-gray-100 dark:bg-midnight">
    <div
      ...
      class="flex items-center justify-center">
        <p class="text-gray-600 text-center font-400">Loading Config...</p>
    </div>
        ...
        <div class="hidden md:block flex-none h-full overflow-y-auto top-0 sticky max-h-screen">
          ...
          <nav class="w-56 pt-6 pb-12 px-3 h-full">
            <a
              ...
              :key="section.title"
              :href="`#${section.title}`"
              class="block py-2 pl-2 text-gray-600 no-underline dark:text-gray-500 hover:bg-gray-200 text-gray-800 dark-hover:text-gray-200 text-base rounded-sm"
            >
              {{ section.title }}
            </a>
          </nav>
